...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuejs_datepicker__ = __webpack_require__(30);
// Load dependencies
...
// Load components
Vue.component('task-list', __webpack_require__(34));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-edd6e1ea", Component.options)
  } else {
    hotAPI.reload("data-v-edd6e1ea", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteTask: function deleteTask(id) {
            ...
            axios.post('delete_task/' + id).then(function (result) {
                _this3.fetchTaskList();
            }).catch(function (err) {
                console.log(err);
            });
        },
        archiveTask: function archiveTask(id) {
            var _this4 = this;

            axios.post('archive_task/' + id).then(function (result) {
    ...
    _c(
      ...
      [
        _c(
          ...
          { staticClass: "box" },
          [
            _c("h2", { staticClass: "title" }, [_vm._v("Things to do:")]),
            _vm._v(" "),
            _c("hr"),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-edd6e1ea", module.exports)
  }
}
